...
public class AcidWithHUDI {

    private static String tableType = HoodieTableType.COPY_ON_WRITE.name();
    private static String tableName = "hoodie_rt";

    private static String tablePath = "E:\\dev\\Projects\\delta-lake\\sample_table";

    private static final Logger LOG = LogManager.getLogger(AcidWithHUDI.class);
